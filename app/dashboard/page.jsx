...
export default function DashboardPage() {
  ...
  // Display all data from start to current index
...
// Custom Dot for highlighting the latest point
  ...
  return (
    <g>
      ...
      >
        ...
        <tspan x={0} dy={14} style={{ fontSize: '10px', fill: '#64748b' }}>
          {unit}
        </tspan>
      </text>
    </g>
